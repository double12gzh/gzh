...
# double12gzhblogs build configuration file, created by
# `ablog start` on Sat Sep 19 14:32:03 2020.
#
...
blog_title = u'double12gzh'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'double12gzhblogs.readthedocs.io'
...
blog_default_author = 'double12gzh'
blog_default_location = 'BJ'
...
# Default is ``{}``.
blog_locations = {
   'BJ': ('Beiing', 'https://en.wikipedia.org/wiki/Beijing?wprov=srpw1_0'),
}
...
html_theme_options = {
    "travis_button": False,
    # "github_user": "double12gzh",
    # "github_repo": "blogsite",
    # "description": "大海星",
    # "logo": "headshot-circle.png",
}
...
htmlhelp_basename = 'double12gzhblogsdoc'


ablog_doctrees= '__doctrees__'
ablog_website= '__website__'
...
def setup(app):
    app.add_css_file('double12gzh.css')
